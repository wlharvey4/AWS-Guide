...
#+begin_src makefile :tangle Makefile
  ### PROGRAM
  PROG = AWS-Guide
  TOOLS= tools # directory for tools
  VERS = $$(tools/version.sh) # a shell program to extract PROG.org’s Version
  ...
  ### HTML DIR
  DIR   = aws-guide  # dir into which all html files are compiled
  INDEX = index.html # entry for html
...
#+header: :tangle tools/version.sh :mkdirp t :shebang "#!/usr/bin/env bash"
#+begin_src sh
